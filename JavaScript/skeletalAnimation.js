...
var skeletalAnimation = new function() {
	...
	this.init = function(_canvas,_ctx) {
		canvas = _canvas;
		ctx = _ctx;
	...
	this.Mesh = function(x,y,color,scale) {
		this.x = x;
		this.y = y;
		this.segments = [10];
		this.color = color;
		...
		this.HEAD_WIDTH = 50 * scale;
		this.HEAD_HEIGHT = 50 * scale;
		this.TORSO_WIDTH = 40 * scale;
		this.TORSO_HEIGHT = 100 * scale;
		this.ARM_WIDTH = 10 * scale;
		this.ARM_HEIGHT = 50 * scale;
		this.LEG_WIDTH = 10 * scale;
		this.LEG_HEIGHT = 70 * scale;
		this.WIDTH = this.TORSO_WIDTH;
		this.HEIGHT = this.TORSO_HEIGHT + this.LEG_HEIGHT * 2;
	...
	this.Mesh.prototype.LEFT_PRESS_CYCLE = [
	0.1, // animation speed
	[
	0.0, // torso
	0.0, // head
	...
	this.Mesh.prototype.RIGHT_PRESS_CYCLE = [
	0.1, // animation speed
	[
	0.0, // torso
	0.0, // head
